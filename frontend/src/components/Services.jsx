  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-end p-6 md:p-8">
        <div className="w-12 h-12 flex items-center justify-center mb-4 group-hover:scale-110"
          style={{ backgroundColor: 'rgba(247,230,0,0.1)', border: '1px solid rgba(247,230,0,0.2)', transition: 'transform 0.3s' }}>
        ...
        <div className="absolute inset-0 border border-transparent group-hover:border-[rgba(247,230,0,0.2)] pointer-events-none" style={{ transition: 'border-color 0.5s' }} />
        <div className="absolute bottom-0 left-0 h-[2px] w-0 group-hover:w-full" style={{ backgroundColor: '#F7E600', transition: 'width 0.5s' }} />
      </div>
    </motion.div>
  );
}
